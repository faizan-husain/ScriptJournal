<%-- 
    ...
    Created on : 21-May-2025, 5:53:23 pm
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        <main class="secondary-background  "  style="padding-bottom: 41px;">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="reg-form" action="RegisterServlet" method="POST">
                                ...
                                <button id="sumbimt-btn" type="submit" class="btn btn-secondary mt-2">Submit</button>
                            </form>
        ...
        <!--external sweet alert when register done successfully-->
